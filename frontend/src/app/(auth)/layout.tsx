      ...
      >
        ...
        <div className="w-full h-full bg-gradient-to-br from-blue-600 via-blue-700 to to-blue-800 flex justify-center items-center">
          <div className="text-center text-white p-8 max-w-md">
            ...
            <p className="text-3xl font-bold font-serif -mb-6  mx-auto">
              Welcome to
            </p>
            <p className="text-8xl font-extrabold font-sans border-b-3 pb-2">
              Docure
            </p>
            <p className="text-3xl font-bold pt-2 font-sans">
              Your Health, Our Priority
            </p>
            <p className="font-serif font-thin py-8">
              Healthcare doesn’t have to be intimidating. We’re here to turn
              your worries into answers, your questions into clarity, and your
              health journey into something you actually feel in control of
            </p>
          </div>
        </div>
      </div>
