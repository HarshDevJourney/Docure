...
export const healthcareCategories = [
  {
    ...
    color: 'bg-blue-500',
    href: '/doctor-list?category=primary-care'
  },
  {
    id: 'manage-condition',
    ...
    color: 'bg-green-500',
    href: '/doctor-list?category=manage-condition'
  },
  {
    ...
    color: 'bg-yellow-500',
    href: '/doctor-list?category=mental-behavioral-health'
  },
  {
    id: 'sexual-health',
    title: 'Sexual Health',
    ...
    color: 'bg-pink-500',
    href: '/doctor-list?category=sexual-health'
  },
  {
    id: 'childrens-health',
    ...
    color: 'bg-red-500',
    href: '/doctor-list?category=childrens-health'
  },
  {
    id: 'senior-health',
    title: 'Senior Health',
    ...
    color: 'bg-orange-500',
    href: '/doctor-list?category=senior-health'
  },
  {
    id: 'womens-health',
    ...
    color: 'bg-purple-500',
    href: '/doctor-list?category=womens-health'
  },
  {
    id: 'mens-health',
    title: "Men's Health",
    ...
    color: 'bg-indigo-500',
    href: '/doctor-list?category=mens-health'
  },
  {
    id: 'wellness',
    title: 'Wellness',
    ...
    href: '/doctor-list?category=wellness'
  }
];
