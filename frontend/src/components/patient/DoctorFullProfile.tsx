  ...
  const mockData = {
    ...
    patientReviews: [
      ...
      },
      {
        ...
        rating: 4,
        date: "2024-01-08",
        comment: "Good experience overall. Waiting time was a bit long but doctor was excellent.",
        helpful: 5,
      },
    ],
    gallery: [
        ...
        <div className='flex flex-col justify-center items-center min-h-[80vh] px-4'>
          <div className='text-center'>
            ...
            <p className='text-gray-600 mb-8 max-w-md'>
              We couldnt find the doctor you are looking for. They may have been removed or the link
              might be incorrect.
            </p>
            <Button
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <div className='flex flex-wrap items-center gap-2 sm:gap-3 mb-4'>
                    <div className='flex items-center gap-1.5 sm:gap-2 bg-white/15 backdrop-blur-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-white/20'>
                      ...
                      <span className='text-base sm:text-lg font-bold'>{mockData.rating}</span>
              ...
              <div className='grid grid-cols-2 gap-3 sm:gap-4'>
                <div className='bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300'>
                  <div className='flex items-center gap-2 sm:gap-3 mb-2'>
                    ...
                    <span className='text-xs sm:text-sm font-medium text-blue-200'>Patients</span>
                  </div>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12'>
        <Tabs value={activeTab} onValueChange={setActiveTab} className='w-full'>
          ...
          >
            <TabsTrigger
              value='overview'
              className={tabTriggerClass + " w-full sm:w-auto justify-center"}
            >
            ...
            >
              ...
              <span className='sm:inline'>Location</span>
            </TabsTrigger>
          </TabsList>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4'>
                      ...
                      <div className='bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-200 hover:shadow-md transition-shadow duration-300'>
                        ...
                        <p className='text-emerald-700 text-sm sm:text-base'>
                          {mockData.totalPatients.toLocaleString()}+ treated
                        </p>
                      </div>
                  ...
                  <CardContent className='p-4 sm:p-6'>
                    <div className='text-center'>
                      ...
                      <Button
                        ...
                        onClick={() => router.push(`/patient/booking/${doctor._id}`)}
                      >
                  ...
                  <CardContent className='p-4 sm:p-6'>
                    <div className='text-center'>
                      ...
                      <p className='text-emerald-600 font-medium mb-3 sm:mb-4 text-sm sm:text-base'>
                        Based on {mockData.totalReviews.toLocaleString()} reviews
                      </p>
                      <div className='bg-white/60 backdrop-blur-sm rounded-xl p-3 sm:p-4 border border-emerald-200'>
                        ...
                        <Progress value={mockData.satisfaction} className='h-2 bg-emerald-100' />
                      </div>
                    </div>
                  </CardContent>
                </Card>
