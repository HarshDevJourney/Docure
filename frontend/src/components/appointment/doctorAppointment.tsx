                            ...
                            >
                                ...
                                >
                                    {apt.patientID?.avatar ??
                                        apt.patientID?.name?.slice(0, 2).toUpperCase()}
                                </div>
                                {isLive && (
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            >
                                <span className='relative flex items-center gap-1.5'>
                                    {isLive ? (
                                        <>
                                            <LightningIcon className='text-white' /> Resume
                                            Consultation
                                        </>
                                    ) : (
                                        <>
                            ...
                            {apt.patientID?.phone && (
                                <>
                                    ...
                                    <span className='flex items-center gap-1 text-white/60 text-xs'>
                                        <PhoneIcon className='text-white/50' />{" "}
                                        {apt.patientID?.phone}
                                    </span>
                                </>
                            )}
...
const DoctorAppointments: React.FC = () => {
    ...
    const handleDelete = (aptId: string) =>
        setPast((prev) => prev.map((a) => (a._id === aptId ? { ...a, prescription: null } : a)));
