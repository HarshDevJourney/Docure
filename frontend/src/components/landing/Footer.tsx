      ...
      <div className="container mx-auto px-6">
        ...
        <div className="border-t border-blue-500 mt-10 pt-6 pb-3 flex flex-col md:flex-row md:justify-between md:items-center">
          <div className="mb-4 md:mb-0">
            ...
            <form className="flex max-w-7xl">
              <input
                type="email"
                placeholder="Enter your email"
                className="px-4 py-2 rounded-l-md bg-blue-900 text-white placeholder-blue-300 border-none outline-none"
              />
              <button
                type="submit"
                className="bg-blue-500 px-4 rounded-r-md font-semibold hover:bg-blue-400 transition"
              >
                Subscribe
              </button>
            </form>
